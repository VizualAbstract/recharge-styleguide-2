...
<?php include('header.php'); ?>
					...
					-->
					<link rel="stylesheet" href="/static/prepros/proxy_structure.css" type="text/css">
					<style>
						table.rc_table.rc_table--toggle td:first-child {
							vertical-align: top;
						}
					</style>
					<div id="ReCharge" class="recharge page__accounts">
						<div class="rc_layout__container" flex-max="lg">
							<div class="rc_layout">
